# Generated by Django 4.0.4 on 2022-06-30 22:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.appuser', verbose_name='ID Создателя')),
            ],
            options={
                'verbose_name': 'Проект',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True, verbose_name='ID')),
                ('team_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.team', verbose_name='ID команды')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.appuser', verbose_name='ID Пользователя')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.projectemployee', verbose_name='ID Рабочего')),
                ('initiator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.appuser', verbose_name='ID Инициатора')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_network_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.socialnetwork', verbose_name='ID соц.сети')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.appuser', verbose_name='ID Пользователя')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.project', verbose_name='Проект, которому принадлежит роль')),
            ],
            options={
                'verbose_name': 'Роль',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='main.project', verbose_name='ID Проекта')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.projectemployee', verbose_name='ID Пользователя')),
            ],
            options={
